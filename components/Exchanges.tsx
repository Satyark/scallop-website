    ...
    <div className='flex flex-col justify-center items-center mt-20 w-full'>
        <span className='flex justify-center items-center '>
          <div className='h-[1.5px] w-[100px] md:w-[154px] bg-gradient-to-r from-[#FFFFFF] to-[#1A6AF4]'></div>
            <p className='font-manrope font-bold text-[20px] md:text-[24px] bg-gradient-to-r from-[#1A6AF4] to-[#00DECA] text-transparent bg-clip-text mx-5'>Exchanges</p>
            <div className='h-[1.5px] w-[100px] md:w-[154px] bg-gradient-to-r from-[#1A6AF4] to-[#FFFFFF]'></div>
        </span>
        <div className='flex flex-col md:flex-row justify-center items-center gap-20 mt-10 md:ml-10'>
        ...
        <span className='flex justify-center items-center mt-20'>
          <div className='h-[1.5px] w-[100px] md:w-[154px] bg-gradient-to-r from-[#FFFFFF] to-[#1A6AF4]'></div>
            <p className='font-manrope font-bold text-[20px] md:text-[24px] bg-gradient-to-r from-[#1A6AF4] to-[#00DECA] text-transparent bg-clip-text mx-5'>Incubated by</p>
            <div className='h-[1.5px] w-[100px] md:w-[154px] bg-gradient-to-r from-[#1A6AF4] to-[#FFFFFF]'></div>
        </span>
        ...
        <span className='flex justify-center items-center mt-20'>
          <div className='h-[1.5px] w-[100px] md:w-[154px] bg-gradient-to-r from-[#FFFFFF] to-[#1A6AF4]'></div>
            <p className='font-manrope font-bold text-[20px] md:text-[24px] bg-gradient-to-r from-[#1A6AF4] to-[#00DECA] text-transparent bg-clip-text mx-5'>Partners</p>
            <div className='h-[1.5px] w-[100px] md:w-[154px] bg-gradient-to-r from-[#1A6AF4] to-[#FFFFFF]'></div>
        </span>
