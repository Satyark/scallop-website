...
const Hero = () => {
  return (
    <div className='md:mt-[88px] flex flex-col items-center'>
      ...
      <Cover> <span className='flex flex-col md:flex-row justify-center md:items-center font-clash-grotesk font-semibold bg-gradient-to-r from-[#00DECA] to-[#1A6AF4] text-transparent bg-clip-text text-[36px] md:text-[64px]'><span className='text-white'>DeFi Powered</span> Regulated Accounts</span></Cover> 
      {/* </p> */}
      <span className='flex flex-col items-center'>
        <p className='font-manrope text-[12px] md:text-[18px] text-[#0D152E]'>
